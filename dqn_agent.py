...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if self.t_step == 0:
            ...
            if len(self.memory) > BATCH_SIZE:
                experiences = self.memory.experienceReplay()
    ...
    def learn(self, experiences, gamma):
        ...
        # Normal DQN: Q_targets_next = self.network_target(next_states).detach().max(1)[0].unsqueeze(1) 
        ...
        self.soft_update(self.network, self.network_target, TAU)                     
